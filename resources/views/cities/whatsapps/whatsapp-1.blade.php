        ...
        <div class="wa__popup_content wa__popup_content_left">
            ...
            <div class="wa__popup_content_list">
                <div class="wa__popup_content_item ">
                    <a target="_blank" href="https://{{$template}}.whatsapp.com/send?phone=5511932092772&text=Olá, visitei {{config('app.name')}} e preciso de ajuda sua. Aqui está o link https://demo2.avdesign.com.br" class="wa__stt wa__stt_online">
